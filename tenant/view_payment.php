...
<?php 
// $tenants =$conn->query("SELECT t.*,concat(t.lastname,', ',t.firstname,' ',t.middlename) as name,h.apartment_no,h.price FROM users t inner join apartments h on h.id = t.id where t.id = {$_GET['id']} ");
$tenants = $conn->query("
    SELECT
