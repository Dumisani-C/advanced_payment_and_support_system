					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$tenants =$conn->query("SELECT t.*,concat(t.lastname,', ',t.firstname,' ',t.middlename) as name,h.apartment_no,h.price FROM tenants t inner join apartments h on h.id = t.apartment_id where t.status = 1 order by h.apartment_no desc ");
